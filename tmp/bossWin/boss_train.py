...
class Model(object):
    ...
    def build_model(self, dataset, nb_classes = nbClasses):
        self.model = Sequential()
        self.model.add(Conv2D(filters = 32, kernel_size =(3, 3), padding = 'same', input_shape=dataset.X_train.shape[1:]))
...
if __name__ == '__main__':
    ...
    model.train(dataset, nb_epoch = 1) # 訓練次數
    model.save()
